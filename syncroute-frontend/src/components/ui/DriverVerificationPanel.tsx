...
function safeFormat(dateVal: string | Date | undefined | null, pattern: string): string {
  if (!dateVal) return "";
  try {
    const d = new Date(dateVal);
    if (isNaN(d.getTime())) return "";
    // Simple manual formatting to avoid date-fns issues with invalid dates
    ...
    if (pattern === "MMMM d, yyyy 'at' h:mm a") {
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs font-medium">
                      {safeFormat(dv.verifiedAt, "MMM d, yyyy")}
                    </div>
                  </div>
                </div>
              )}
                  ...
                  <div>
                    ...
                    >
                      {licenseExpired
                        ...
                        : safeFormat(dv.licenseExpiry, "MMM yyyy")}
                    </div>
                  </div>
                </div>
              )}
              ...
              {dv?.verifiedAt && (
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    ...
                    {safeFormat(dv.verifiedAt, "MMMM d, yyyy 'at' h:mm a")}
                  </div>
                </div>
              )}
            </div>
