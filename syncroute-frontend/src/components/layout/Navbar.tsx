    ...
    <>
      ...
      {mobileOpen && (
        <>
          ...
          <div className="fixed top-16 inset-x-0 z-50 md:hidden bg-background border-b border-border shadow-xl animate-in-up">
            <div className="page-container py-4 space-y-1">
              ...
              <div className="pt-3 border-t border-border mt-3">
                {user ? (
                  <>
                    <Link to="/profile" className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-muted-foreground hover:text-foreground hover:bg-accent/60 transition-colors">
                      {user.photo ? (
                        <img src={user.photo} alt={user.name} className="h-6 w-6 rounded-full object-cover" referrerPolicy="no-referrer" />
                      ) : (
                        <div className="h-6 w-6 rounded-full bg-primary/10 flex items-center justify-center">
